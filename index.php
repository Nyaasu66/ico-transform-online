...
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
        <link rel="alternate" title="八七娱乐网" href="https://www.87csn.com" type="application/rss+xml" />
	    <link rel="stylesheet" href="./css/favicon.css" type="text/css" />
	    <title>ICO图标在线转换工具——八七娱乐网</title>
    ...
    <body>
	<div id="favicon-area">
	    <a style="display: block; text-indent: 0em;" href="http://blog.quietguoguo.com/"><img src="./img/Advertising.png" alt="" width="800" />
		</a>
        <h1>ICO图标在线转换</h1>
            <form  method="post" enctype='multipart/form-data'>
				...
				<div id="favicon-output">
				  <div id="favicon-notice" >
					...
					<p style="color:red;"><?php if($typeinfo!=""){echo $typeinfo;}?></p>
					</div>
					</br>
	...
	<div id="favicon-area-copyright">
        &copy;2018 | <a href="https://www.87csn.com">八七娱乐网</a>
    </div>
